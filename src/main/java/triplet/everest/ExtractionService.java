...
//	Tree t = null;
//	t.setValue("NONE");
	//t.setFromString("NONE");
//if(subjectTree == null) subjectTree.add(t);
//if(predicateTree == null) predicateTree.add(t);	
//if(objectTree == null) objectTree.add(t);	
	//	System.out.println("subject: "+subjectTree.value()+", verb: "+predicateTree.value()+", object: "+objectTree.value());
